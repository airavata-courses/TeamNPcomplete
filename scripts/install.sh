...
flask run --host=0.0.0.0 --port=65000 >> /var/log/sga-npcomplete-forecast-decision.log 2>&1 &
...
flask run --host=0.0.0.0 --port=64000 >> /var/log/sga-npcomplete-forecast.log 2>&1 &